...
public class StopPoint extends Location{
	...
	public StopPoint(String naptanId, String platformName, String indicator, String stopLetter,
			String[] modes, String icsCode, String smsCode, String stopType,
			String stationNaptan, String accessibilitySummary, String hubNaptanCode,
			Line[] lines, LineGroup[] lineGroup, LineModeGroup[] lineModeGroups,
			String fullName, String naptanMode, boolean status, String id, String url,
			String commonName, long distance, String placeType,
		...
		this.setInformation(commonName); // common
													// name,
													// because
													// user-set
													// name
