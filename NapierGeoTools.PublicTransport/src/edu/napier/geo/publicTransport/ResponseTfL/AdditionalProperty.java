...
public class AdditionalProperty implements Serializable {
	 ...
	 * Commons CC BY-NC-SA 3.0 license. Author of the used software: Tim
	 * Boudreau. Changes: Jan-Niklas Keiner 2017/03/02 Changes: separation of
	 * inner classes, adding getter methods and making objects compatible to
	 * objects of the public transport project. License:
	...
	public AdditionalProperty(String category, String key,
			String sourceSystemKey, String value, String modified) {
